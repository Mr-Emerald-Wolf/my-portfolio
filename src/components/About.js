                ...
                <div className='flex p-5 bg-slate-50 dark:bg-gray-900 flex-col-reverse md:flex-row '>
                    <div className="flex p-1 items-center">
                        <div className='container text-center mx-auto'>
                            ...
                            <p className='text-sky-800 dark:text-sky-200 lg:w-2/3 mx-auto text-left md:text-xl p-1'>Coding has always been my passion and I would love to explore new areas like ML {"&"} Competetive Programming.</p>
                            ...
                            <p className='text-sky-800 dark:text-sky-200 lg:w-2/3 mx-auto text-left md:text-xl p-1'>I create web applications using ReactJS and Tailwind. </p>
                        </div>
                    </div>
                    <div className="p-1 md:w-1/2">
                        <img className='mx-auto w-2/3 md:w-2/3 lg:w-1/2' src="./img/profile.jpg" alt="Profile" />
                    </div>
                </div>
            </section>
        </>
